...
async def main() -> None:
    ...
    with st.sidebar:
        ...
        if st.button(":material/upload: Share", use_container_width=True):
            share_chat_dialog()
    ...
    if len(messages) == 0:
        match agent_client.agent:
            ...
            case "research-assistant":
                WELCOME = (
                    "Hello! I'm an AI-powered research assistant with web search and a calculator. Ask me anything!"
                )
            case _:
                        ...
                        for _ in range(len(call_results)):
                            ...
                            if is_json_string(tool_result.content):
                                ...
                                if (
                                    ...
                                    and "data" in tool_result_content
                                    and "docx" in tool_result_content["data"]
                                ):
